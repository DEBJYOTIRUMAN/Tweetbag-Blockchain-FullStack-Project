...
const PostFeed = ({ post, router, currentAccount, currentUser, posts, setPosts }) => {
  return (
    <div className={style.wrapper}>
      ...
      <Post post={post} currentAccount={currentAccount} currentUser={currentUser} posts={posts} setPosts={setPosts} />
