...
const CommentModal = ({ post, currentAccount, currentUser, setCommentModal, posts, setPosts, router, pathName }) => {
  ...
  const handleComment = async (event) => {
    ...
    fetch(`https://tweetbag.onrender.com/api/post/comment/${post._id}`, {
      method: "PUT",
      headers: {
      ...
      .then((res) => res.json())
      .then((document) => {
        setPosts(posts.map((item) => (item._id === document._id ? document : item)));
        ...
        <div className={style.body}>
          <div className={style.header}>
            ...
            <img
              ...
              alt="Image"
              className={post.isProfileImageNft
              ? `${style.image} smallHex`
              : style.image}
