...
import PostImageMinter from "./postMintingModal/PostImageMinter";
...
const PostBox = ({ currentAccount, currentUser, posts, setPosts }) => {
  ...
  const submitPost = async (event) => {
    ...
    formData.append("isPostImageNft", false);
    try {
            ...
            <div className={style.formLowerContainer}>
              <div className={style.iconsContainer}>
                <BsCardImage
                  ...
                  onClick={() => {
                    setPostMessage(""), setMintModalVisible(true);
                  }}
                />
                <RiFileGifLine className={style.icon} onClick={() => setComingSoon(true)} />
                <RiBarChartHorizontalFill className={style.icon} onClick={() => setComingSoon(true)} />
                <BsEmojiSmile className={style.icon} onClick={() => setComingSoon(true)} />
                <IoMdCalendar className={style.icon} onClick={() => setComingSoon(true)} />
                <MdOutlineLocationOn className={style.icon} onClick={() => setComingSoon(true)} />
              </div>
              <button
                type="submit"
