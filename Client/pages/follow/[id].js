...
const follow = () => {
  ...
  const user = allUsers.find((user) => user.walletAddress === id);
  useEffect(() => {
    if (!user) return;
    if (activeTab === "Followers") {
      fetch("https://tweetbag.onrender.com/api/user/followers", {
        method: "POST",
        headers: {
      ...
      fetch("https://tweetbag.onrender.com/api/user/following", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
