...
export default function Home() {
  const { appStatus, connectToWallet, currentAccount, currentUser, setCurrentUser, posts, setPosts, allUsers, setAllUsers, news } = useContext(TweetbagContext);
  ...
  const userLoggedIn = (
    <div className={style.content}>
      <Sidebar currentAccount={currentAccount} currentUser={currentUser} posts={posts} setPosts={setPosts} />
      <Feed currentAccount={currentAccount} currentUser={currentUser} posts={posts} setPosts={setPosts} />
